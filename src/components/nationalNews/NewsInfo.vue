  ...
  <div class="newsInfo">
    <div class="width">
      ...
      <div class="bread">
        ...
        >
        <router-link to="/news">国内新闻 / National News</router-link>
      </div>
      ...
      <div style="margin-left: 580px;margin-top: 20px"  v-if="star==0">
        <el-button type="text" @click="clickLeaveMessage()">新闻留言</el-button><i class="el-icon-chat-dot-round"></i>
        <el-button type="text" @click="clickPush(1)">推荐文章</el-button><i class="el-icon-star-off"></i>
      </div>
      <div style="margin-left: 580px;margin-top: 20px"  v-if="star==1">
        <el-button type="text" @click="clickLeaveMessage()">新闻留言</el-button><i class="el-icon-chat-dot-round"></i>
        <el-button type="text" @click="clickPush(0)">取消推荐</el-button><i class="el-icon-star-on"></i>
      </div>
    </div>
    <el-dialog
      title="请留言"
